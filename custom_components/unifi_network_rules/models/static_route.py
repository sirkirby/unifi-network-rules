...
class TypedStaticRoute:
    ...
    static_route_interface: Optional[str]  # Interface name/ID  
    gateway_device: Optional[str]       # Gateway device MAC or ID
    ...
    # Optional properties
    static_route_distance: Optional[int] = None  # Routing distance/metric
...
class StaticRoute:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"StaticRoute(id={self.id}, name={self.name}, "
            f"destination={self.destination}, enabled={self.enabled})"
        )
