...
class ApiHandlerMixin:
    ...
    async def _handle_api_request(
        self, request_type: str, action_coroutine: Callable[[], Coroutine]
    ) -> tuple[bool, Any | None]:
            ...
            if is_auth_error:
                ...
                if "429" in error_str or "too many requests" in error_str:
                    ...
                    if hasattr(self, "_max_backoff"):
                        backoff = min(
                            30 * (2 ** (getattr(self, "_consecutive_failures", 1) - 1)),
    ...
    async def _handle_authentication_retry(
        self, request_type: str, action_coroutine: Callable[[], Coroutine], error_context: str
    ) -> tuple[bool, Any | None]:
