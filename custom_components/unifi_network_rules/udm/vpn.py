...
class VPNMixin:
    ...
    async def get_vpn_configs(self, include_clients=True, include_servers=True) -> list[VPNConfig]:
        ...
        try:
            ...
            for network in network_data:
                ...
                from ..helpers.rule import classify_vpn_type, is_vpn_network
    ...
    async def add_vpn_config(self, config_data: dict[str, Any]) -> VPNConfig | None:
    ...
    async def add_vpn_client(self, client_data: dict[str, Any]) -> VPNConfig | None:
    ...
    async def add_vpn_server(self, server_data: dict[str, Any]) -> VPNConfig | None:
