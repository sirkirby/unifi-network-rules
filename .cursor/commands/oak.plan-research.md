...
**HOW TO LAUNCH:** Use Background Agents to run tasks in parallel cloud environments. Launch cloud agents from the Cursor editor or cursor.com/agents. Each agent works in an isolated copy of the codebase using git worktrees.
...
agent_assigned: false    findings_file: null
...
- **Deep research via MCP web-search + background agents**: Agent-specific research guidance is incorporated above